...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.OneSignalImplementation+OSEmailSubscriptionObserver, Com.OneSignal", OneSignalImplementation_OSEmailSubscriptionObserver.class, __md_methods);
	}
	...
	public OneSignalImplementation_OSEmailSubscriptionObserver ()
	{
		...
		if (getClass () == OneSignalImplementation_OSEmailSubscriptionObserver.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.OneSignalImplementation+OSEmailSubscriptionObserver, Com.OneSignal", "", this, new java.lang.Object[] {  });
	}
