...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.OneSignalImplementation+OSNotificationOpenedHandler, Com.OneSignal", OneSignalImplementation_OSNotificationOpenedHandler.class, __md_methods);
	}
	...
	public OneSignalImplementation_OSNotificationOpenedHandler ()
	{
		...
		if (getClass () == OneSignalImplementation_OSNotificationOpenedHandler.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.OneSignalImplementation+OSNotificationOpenedHandler, Com.OneSignal", "", this, new java.lang.Object[] {  });
	}
