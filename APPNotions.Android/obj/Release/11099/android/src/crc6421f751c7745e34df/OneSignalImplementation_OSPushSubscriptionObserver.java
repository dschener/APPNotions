...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.OneSignalImplementation+OSPushSubscriptionObserver, Com.OneSignal", OneSignalImplementation_OSPushSubscriptionObserver.class, __md_methods);
	}
	...
	public OneSignalImplementation_OSPushSubscriptionObserver ()
	{
		...
		if (getClass () == OneSignalImplementation_OSPushSubscriptionObserver.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.OneSignalImplementation+OSPushSubscriptionObserver, Com.OneSignal", "", this, new java.lang.Object[] {  });
	}
