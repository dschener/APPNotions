...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.OneSignalImplementation+OSChangeTagsUpdateHandler, Com.OneSignal", OneSignalImplementation_OSChangeTagsUpdateHandler.class, __md_methods);
	}
	...
	public OneSignalImplementation_OSChangeTagsUpdateHandler ()
	{
		...
		if (getClass () == OneSignalImplementation_OSChangeTagsUpdateHandler.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.OneSignalImplementation+OSChangeTagsUpdateHandler, Com.OneSignal", "", this, new java.lang.Object[] {  });
	}
