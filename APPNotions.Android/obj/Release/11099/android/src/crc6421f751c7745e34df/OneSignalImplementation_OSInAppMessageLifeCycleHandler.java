...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.OneSignalImplementation+OSInAppMessageLifeCycleHandler, Com.OneSignal", OneSignalImplementation_OSInAppMessageLifeCycleHandler.class, __md_methods);
	}
	...
	public OneSignalImplementation_OSInAppMessageLifeCycleHandler ()
	{
		...
		if (getClass () == OneSignalImplementation_OSInAppMessageLifeCycleHandler.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.OneSignalImplementation+OSInAppMessageLifeCycleHandler, Com.OneSignal", "", this, new java.lang.Object[] {  });
	}
